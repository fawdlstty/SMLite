...
namespace Fawdlstty.SMLite.ItemStruct {
	public class _SMLite_ConfigState<TState, TTrigger> {
		...
		public _SMLite_ConfigState<TState, TTrigger> WhenFuncAsync (TTrigger trigger, Func<TState, TTrigger, CancellationToken, Task<TState>> callback) {
		...
		public _SMLite_ConfigState<TState, TTrigger> WhenFuncAsync<T1> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, Task<TState>> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenFuncAsync<T1, T2> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, Task<TState>> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenFuncAsync<T1, T2, T3> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, Task<TState>> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenFuncAsync<T1, T2, T3, T4> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, Task<TState>> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenFuncAsync<T1, T2, T3, T4, T5> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, T5, Task<TState>> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenFuncAsync<T1, T2, T3, T4, T5, T6> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, T5, T6, Task<TState>> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenFuncAsync<T1, T2, T3, T4, T5, T6, T7> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, T5, T6, T7, Task<TState>> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenFuncAsync<T1, T2, T3, T4, T5, T6, T7, T8> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, T5, T6, T7, T8, Task<TState>> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenFuncAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, T5, T6, T7, T8, T9, Task<TState>> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}

		public _SMLite_ConfigState<TState, TTrigger> WhenActionAsync (TTrigger trigger, Func<TState, TTrigger, CancellationToken, Task> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenActionAsync<T1> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, Task> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenActionAsync<T1, T2> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, Task> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenActionAsync<T1, T2, T3> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, Task> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenActionAsync<T1, T2, T3, T4> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, Task> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenActionAsync<T1, T2, T3, T4, T5> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, T5, Task> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenActionAsync<T1, T2, T3, T4, T5, T6> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, T5, T6, Task> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenActionAsync<T1, T2, T3, T4, T5, T6, T7> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, T5, T6, T7, Task> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenActionAsync<T1, T2, T3, T4, T5, T6, T7, T8> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, T5, T6, T7, T8, Task> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		public _SMLite_ConfigState<TState, TTrigger> WhenActionAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9> (TTrigger trigger, Func<TState, TTrigger, CancellationToken, T1, T2, T3, T4, T5, T6, T7, T8, T9, Task> callback) {
			var _item = new _SMLite_ConfigItem<TState, TTrigger> (_SMLite_BuildItem.State | _SMLite_BuildItem.Trigger | _SMLite_BuildItem.CancellationToken, State, trigger, callback, callback.Method);
			return _try_add_trigger (trigger, _item);
		}
		...
		internal async Task<TState> _trigger_async (TTrigger trigger, CancellationToken token, params object[] args) {
